...
$sql="SELECT * FROM cadastroclientes WHERE lmg !=''";
...
$tabela .= '<tr>';
$tabela .= '<td colspan="2">Lista de Estudantes - Atestados Médicos</tr>';
$tabela .= '</tr>';
$tabela .= '<tr>';
$tabela .= '<td><b>CH</b></td>';
...
$tabela .= '<td><b>ATESTADO / LICENÇA</b></td>';
$tabela .= '<td><b>PERÍODOS / MOTIVO / DESCRIÇÃO</b></td>';
$tabela .= '</tr>';
...
$tabela .= '<td>'.$dados['lmg'].'</td>';
$tabela .= '<td>'.$dados['mot'].'</td>';
$tabela .= '</tr>';
}
