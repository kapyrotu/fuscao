...
//$setAutoFilter = $sheet->setAutoFilter("A1:C9");
...
$tabela .= '<tr>';
$tabela .= '<td colspan="2">Lista de Alunos 2015 - FUSCAO</tr>';
$tabela .= '</tr>';
$tabela .= '<tr>';
$tabela .= '<td><b>CH</b></td>';
$tabela .= '<td><b>CÓDIGO</b></td>';
$tabela .= '<td><b>NOME</b></td>';
$tabela .= '<td><b>DT_NASCIMENTO</b></td>';
...
$tabela .= '<td>'.$dados['dtn'].'</td>';
$tabela .= '<td>'.$dados['ane'].'</td>';
$tabela .= '<td>'.$dados['tur'].'</td>';
$tabela .= '<td>'.$dados['ent'].'</td>';
$tabela .= '<td>'.$dados['sai'].'</td>';
